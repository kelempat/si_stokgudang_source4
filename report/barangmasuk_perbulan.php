...
<html>
    <head>
        <title>Cetak Data Barang Masuk Perbulan</title>
        ...
        <div class="container">
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                       <h2>Sistem Informasi Stok Gudang Pada PT Hijau Surya Biotechindo </h2>
                        ...
                        <hr>
                        <h3>DATA BARANG MASUK BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM masuk WHERE substr(tanggal_masuk,1,7)='$ambilthn-$ambilbln'";
